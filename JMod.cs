    ...
    public class JMod : MelonMod
    {
        ...
        public static void ShowMenu()
        {
            if (showCheatsPopup)
            {
                ...
                yAxis += 35;
                foreach (MelonPreferences_Entry<bool> toggle in ToggleCategory.Entries)
                {
                ...
                yAxis += 25;
                foreach (MelonPreferences_Entry<float> mult in MultiplierFloatCategory.Entries)
                {
                ...
                foreach (MelonPreferences_Entry<int> mult in MultiplierIntCategory.Entries)
                {
                    string multLabel = mult.DisplayName;
